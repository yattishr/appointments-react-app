  ...
  renderAppointmentConfirmation() {
    ...
    return (
      <section>
        ...
        <p>
          Contact number: <span style={spanStyle}>{this.state.contact_number}</span>
        </p>        
        <p>
          Appointment:{" "}
          <span style={spanStyle}>
                  ...
                  <p>
                    <section>
                      ...
                      <TextField
                        style={{ display: "block" }}
                        name="contact_number"
                        hintText="073 253 2694"
                        floatingLabelText="Contact number"                        
                        onChange={(evt, newValue) =>
                          this.setState({ contact_number: newValue })
                        }
                      />                      
                      <RaisedButton
